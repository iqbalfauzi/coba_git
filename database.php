...
$db['default']['username'] = 'damri';
$db['default']['password'] = 'damri';
$db['default']['database'] = 'anggaran';
...
$db['default2']['username'] = 'damri';
$db['default2']['password'] = 'damri';
$db['default2']['database'] = 'hris';
